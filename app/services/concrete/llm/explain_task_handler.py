...
class ExplainTaskHandler(TaskHandler):
    ...
    def handle(self, context: Any, query: str) -> str:
        """Handle the explanation task by building a prompt and asking the LLM service."""
        prompt = PromptBuilder.build(LLMTaskType.EXPLAIN, context, query)
